...
static const int64 MAX_MONEY = 10000000000 * COIN; // BoyCoin: maximum of 10B coins (given some randomness), max transaction 10,000,000,000 for now
...
static const uint256 hashGenesisBlockOfficial("0x792fb39db54e16cfd83a0100559461adcc0783ad4dfdb0219357a293e94a6a05");
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 1000 * COIN * 2880 / 250; // BoyCoin: 2880 blocks found a day. Priority cutoff is 1000 BoyCoin day / 250 bytes.
    }
