...
!define COMPANY "Girlcoin project"
!define URL http://www.girlcoin.org/
...
!define MUI_FINISHPAGE_RUN $INSTDIR\girlcoin-qt.exe
...
OutFile girlcoin-0.7.9-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    File ../release/girlcoin-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/girlcoind.exe
    ...
    Delete /REBOOTOK $INSTDIR\girlcoin.exe
...
Section -post SEC0001
    ...
    WriteRegStr HKCR "litecoin\DefaultIcon" "" $INSTDIR\girlcoin-qt.exe
    WriteRegStr HKCR "litecoin\shell\open\command" "" '"$INSTDIR\girlcoin-qt.exe" "$$1"'
SectionEnd
